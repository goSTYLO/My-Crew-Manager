...
class Member(models.Model):
    ...
    def __str__(self):
        username = self.user.username if self.user else "AI"
...
class Goal(models.Model):
    ...
    sprint = models.ForeignKey("sprints.Sprint", on_delete=models.SET_NULL, null=True, blank=True, related_name="project_goals")
    title = models.CharField(max_length=150)
