...
class AIProjectSummaryPage extends StatelessWidget {
  ...
  static Route<Object?> route() =>
      MaterialPageRoute(builder: (_) => const AIProjectSummaryPage());
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _addRoleCard(),
              const SizedBox(height: 24),
              const Text('Tasks Assignments',
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
              const SizedBox(height: 12),
              _taskCard(context, 'Alex', 'Implement use authentication API',
                  'assets/images/profile1.png'),
              _taskCard(context, 'Sarah', 'Design user authentication flow',
                  'assets/images/profile2.png'),
              _taskCard(
                  context,
                  'David',
                  'Prepare necessary data for AI Models',
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      child: const Text('Link and Generate Backlog',
                          style: TextStyle(fontWeight: FontWeight.w600)),
                    ),
                  ),
                ],
  ...
  void _showAssignTaskSheet(BuildContext context,
      {String? name, String? task, String? imagePath}) {
  ...
  Widget _taskCard(
      BuildContext context, String name, String task, String imagePath) {
    return Container(
      margin: const EdgeInsets.only(bottom: 10),
      padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 14),
      decoration: BoxDecoration(
          ...
          IconButton(
            ...
            onPressed: () {
              _showAssignTaskSheet(context,
                  name: name, task: task, imagePath: imagePath);
            },
          ),
        ],
      ),
