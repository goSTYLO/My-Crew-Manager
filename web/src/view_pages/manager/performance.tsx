      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <main className="flex-1 p-6 overflow-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div className={`rounded-xl shadow-sm border p-6 ${theme === "dark" ? "bg-gray-800 border-gray-700 text-white" : "bg-white border-gray-200"}`}>
            ...
            <div className={`rounded-xl shadow-sm border p-6 ${theme === "dark" ? "bg-gray-800 border-gray-700 text-white" : "bg-white border-gray-200"}`}>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className={`text-2xl font-semibold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>18</p>
                </div>
            ...
            <div className={`rounded-xl shadow-sm border p-6 ${theme === "dark" ? "bg-gray-800 border-gray-700 text-white" : "bg-white border-gray-200"}`}>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className={`text-2xl font-semibold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>4</p>
                </div>
            ...
            <div className={`rounded-xl shadow-sm border p-6 ${theme === "dark" ? "bg-gray-800 border-gray-700 text-white" : "bg-white border-gray-200"}`}>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className={`text-2xl font-semibold ${theme === "dark" ? "text-white" : "text-gray-900"}`}>92%</p>
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
            <div className={`rounded-xl shadow-sm border p-6 ${theme === "dark" ? "bg-gray-800 border-gray-700 text-white" : "bg-white border-gray-200"}`}>
              <h3 className={`text-lg font-semibold mb-4 ${theme === "dark" ? "text-white" : "text-gray-800"}`}>Team Performance</h3>
            ...
            <div className={`rounded-xl shadow-sm border p-6 ${theme === "dark" ? "bg-gray-800 border-gray-700 text-white" : "bg-white border-gray-200"}`}>
              <h3 className={`text-lg font-semibold mb-4 ${theme === "dark" ? "text-white" : "text-gray-800"}`}>Recent Activity</h3>
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                  <div>
                    <p className={`text-sm font-medium ${theme === "dark" ? "text-white" : "text-gray-800"}`}>Project Alpha completed</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className={`text-sm font-medium ${theme === "dark" ? "text-white" : "text-gray-800"}`}>New milestone reached</p>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <p className={`text-sm font-medium ${theme === "dark" ? "text-white" : "text-gray-800"}`}>Task assigned to team</p>
            ...
            <div className={`rounded-xl shadow-sm border p-6 ${theme === "dark" ? "bg-gray-800 border-gray-700 text-white" : "bg-white border-gray-200"}`}>
              <h3 className={`text-lg font-semibold mb-4 ${theme === "dark" ? "text-white" : "text-gray-800"}`}>Goals</h3>
              <div className="space-y-4">
                <div>
          ...
          <div className="grid grid-cols-1 gap-6 mt-8">
            {/* Task 1 */}
            <div className={`rounded-xl shadow-sm border p-6 flex items-center justify-between ${theme === "dark" ? "bg-gray-800 border-gray-700 text-white" : "bg-white border-gray-200"}`}>
              <div>
